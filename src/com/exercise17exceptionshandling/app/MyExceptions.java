...
public class MyExceptions {
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println("Het, be careful. You are not directing to a valid index");
		}
		finally
		{
		...
		for(int i=0; i<10;i++)
		{
			...
			{
				System.out.println("Hey, the number you input is wrog. Do it again!!");
				input.next();
				i--;
			}
			catch(InputMismatchException e)
			{
				System.out.println("Hey, the umber you input is wrog. Do it again!!");	
				input.next();
				i--;
			}
			finally
